...
xlabel('Time (day)');
ylabel('Percentage change of tumor size (%)');
title('TAS-102+Bevacizumab');
set(gcf,'unit','centimeters','position',[10 10 20 15])
print('picture/TASBEV_TumorSize','-dpng','-r600')
...
hold on
plot(linspace(36.5,36.5,100),linspace(-1,1,100),'--','color','#0033ff','LineWidth',2);

text(100,-0.60,'CR/PR','FontSize',20);
text(103,-0.15,'SD','FontSize',20);
text(103,0.50,'PD','FontSize',20);

text(13,0.6,'DCR of clinical data:','FontSize',20,'color',[190 190 190]./255);
text(37.5,0.6,'62.8%','FontSize',20,'color',[190 190 190]./255);

text(7.5,0.8,'DCR of model prediction:','FontSize',20,'color',[255 215 0]./255);
text(37.5,0.8,'64%','FontSize',20,'color',[255 215 0]./255);
...
set(gca,'FontSize',18);
set(gca,'FontName','Arial');
ylabel('Change from baseline tumor size (%)');
title('TAS-102+Bevacizumab');
set(gcf,'unit','centimeters','position',[10 10 40 15])
print('picture/TASBEV_Bar','-dpng','-r600')
