...
label1=0;label2=0;
average1=zeros(7,sample);average2=zeros(7,sample);
...
for i=1:sample
    ...
    hold on
    plot(VX,Y1,'.', 'MarkerSize', 35,'color','#f20c00');
    hold on 
    plot(VX,Y2,'color','#ffcc00','LineWidth',4);
    hold on 
    plot(VX,Y2,'.', 'MarkerSize', 35,'color','#ffcc00');
...
print('picture/Placebo_TumorSize','-dpng','-r600')

figure(2)

Volume_Placebo = Response(2,:);
Volume_Placebo_Sort = sort(Volume_Placebo,2,'descend');
bar(Volume_Placebo_Sort,'FaceColor','#0099ff');
...
hold on
plot(linspace(85.5,85.5,100),linspace(-1,1,100),'--','color','#0033ff','LineWidth',2);

text(100,-0.60,'CR/PR','FontSize',20);
text(103,-0.15,'SD','FontSize',20);
text(103,0.50,'PD','FontSize',20);

text(62,0.6,'DCR of clinical data:','FontSize',20,'color',[190 190 190]./255);
text(86.5,0.6,'15.5%','FontSize',20,'color',[190 190 190]./255);

text(56.5,0.8,'DCR of model prediction:','FontSize',20,'color',[30 144 255]./255);
text(86.5,0.8,'15%','FontSize',20,'color',[30 144 255]./255);
...
print('picture/Placebo_Bar','-dpng','-r600')
