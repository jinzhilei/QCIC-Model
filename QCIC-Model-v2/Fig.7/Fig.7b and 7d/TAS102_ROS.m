...
file='./TSA102_ROC/T_C_sample.mat';
save(file,'T_C_sample');

file='./TSA102_ROC/T1_C_sample.mat';
save(file,'T1_C_sample');

file='./TSA102_ROC/T8_C_sample.mat';
save(file,'T8_C_sample');

file='./TSA102_ROC/T8Treg_sample.mat';
save(file,'T8Treg_sample');

file='./TSA102_ROC/T1Treg_sample.mat';
