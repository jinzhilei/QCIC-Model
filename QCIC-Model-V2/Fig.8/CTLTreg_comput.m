function [Death_low,Death_high]=CTLTreg_comput(mu,sigma)
...
%% load
file_1='./ProAnalysis/T8Treg_low.mat';
A1=cell2mat(struct2cell(load(file_1)));

file_2='./ProAnalysis/T8Treg_high.mat';
A2=cell2mat(struct2cell(load(file_2)));

file_K1='./ProAnalysis/T8Treg_K3_low.mat';
B1=cell2mat(struct2cell(load(file_K1)));

file_K2='./ProAnalysis/T8Treg_K3_high.mat';
