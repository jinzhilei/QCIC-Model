...
AUC=[AUC_T8,AUC_T1,AUC_T1Treg,AUC_T8Treg]
...
ylabel('Sensitivity');
title('TAS-102')
legend([P_T8 P_T1 P_T1Treg P_T8Treg],'CTL           AUC=0.77','Th1            AUC=0.75','Th1/Treg    AUC=0.72','CTL/Treg   AUC=0.62','location','southeast');
legend('boxon')
set(gcf,'unit','centimeters','position',[3 15 18 16])
print('ROC_TAS-102','-dpng','-r600')
