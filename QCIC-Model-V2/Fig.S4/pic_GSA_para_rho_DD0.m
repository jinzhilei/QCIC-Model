function pic_GSA_para_rho_DD0()

file_1 = './Data_GSA_para/rho_DD0_GSA.mat';
...
text(0.835,80,'DCR','FontSize',26,'color','#000000');
text(0.835,20,'PD','FontSize',26,'color','#000000');
...
xlabel('Antigen activation rate {\bf (\rho_{DD0})} ');
ylabel('RECIST (%)');
set(gcf,'unit','centimeters','position',[4 20 18 10])
print('rho_DD0_GSA','-dpng','-r600')
