function pic_GSA_para_sigma_X1()

file_1 = './Data_GSA_para/sigma_X1_GSA.mat';
...
text(0.078,80,'DCR','FontSize',26,'color','#000000');
text(0.078,20,'PD','FontSize',26,'color','#000000');
...
xlabel('Chemotherapy killing coefficient of DSTC {\bf (\sigma_{X1})} ');
ylabel('RECIST (%)');
set(gcf,'unit','centimeters','position',[4 20 18 10])
print('sigma_X1_GSA','-dpng','-r600')
