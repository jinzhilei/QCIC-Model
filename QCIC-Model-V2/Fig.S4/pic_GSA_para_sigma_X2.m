function pic_GSA_para_sigma_X2()

file_1 = './Data_GSA_para/sigma_X2_GSA.mat';
...
text(0.0825,80,'DCR','FontSize',26,'color','#000000');
text(0.0825,20,'PD','FontSize',26,'color','#000000');
...
xlabel('Chemotherapy killing coefficient of DRTC {\bf (\sigma_{X2})} ');
ylabel('RECIST (%)');
set(gcf,'unit','centimeters','position',[4 20 18 10])
print('sigma_X2_GSA','-dpng','-r600')
