function pic_GSA_para_beta_X3()

file_1 = './Data_GSA_para/beta_X3_GSA.mat';
...
text(0.06,80,'DCR','FontSize',26,'color','#000000');
text(0.06,10,'PD','FontSize',26,'color','#000000');
...
xlabel('Proliferation rate of DPTC{\bf (\beta_{X3})} ');
ylabel('RECIST (%)');
set(gcf,'unit','centimeters','position',[4 20 18 10])
print('beta_X3_GSA','-dpng','-r600')
