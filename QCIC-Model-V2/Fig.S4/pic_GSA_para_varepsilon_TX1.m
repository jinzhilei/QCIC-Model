function pic_GSA_para_varepsilon_TX1()

file_1 = './Data_GSA_para/varepsilon_TX1_GSA.mat';
...
set(gca,'XLim',[a b]);
set(gca,'YLim',[0 100]);
set(gca,'XTickLabel',{'3.5\times10^{-4}','4\times10^{-4}','4.5\times10^{-4}'});
set(gca,'Linewidth',1);
set(gca,'FontSize',18);
set(gca,'FontName','Arial');
xlabel('Effective coefficient of bevacizumab on DSTC {\bf (\epsilon_{TX1})} ');
ylabel('RECIST (%)');
set(gcf,'unit','centimeters','position',[4 20 18 10])
print('varepsilon_TX1_GSA','-dpng','-r600')
