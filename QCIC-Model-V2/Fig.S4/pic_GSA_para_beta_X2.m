function pic_GSA_para_beta_X2()

file_1 = './Data_GSA_para/beta_X2_GSA.mat';
...
text(0.0465,80,'DCR','FontSize',26,'color','#000000');
text(0.0465,20,'PD','FontSize',26,'color','#000000');
...
xlabel('Proliferation rate of DRTC {\bf (\beta_{X2})} ');
ylabel('RECIST (%)');
set(gcf,'unit','centimeters','position',[4 20 18 10])
print('beta_X2_GSA','-dpng','-r600')
