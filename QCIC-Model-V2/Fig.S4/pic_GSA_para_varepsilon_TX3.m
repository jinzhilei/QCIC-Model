function pic_GSA_para_varepsilon_TX3()

file_1 = './Data_GSA_para/varepsilon_TX3_GSA.mat';
...
xlabel('Effective coefficient of bevacizumab on DPTC {\bf (\epsilon_{TX3})} ');
ylabel('RECIST (%)');
set(gcf,'unit','centimeters','position',[4 20 18 10])
print('varepsilon_TX3_GSA','-dpng','-r600')
