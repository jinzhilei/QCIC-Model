function pic_GSA_para_rho_X3X1()

file_1 = './Data_GSA_para/rho_X3X1_GSA.mat';
...
text(0.37,80,'DCR','FontSize',26,'color','#000000');
text(0.37,20,'PD','FontSize',26,'color','#000000');
...
xlabel('Pressure  mutation rate of DSTC to DPTC{\bf (\rho_{X3X1})} ');
ylabel('RECIST (%)');
set(gcf,'unit','centimeters','position',[4 20 18 10])
print('rho_X3X1_GSA','-dpng','-r600')
