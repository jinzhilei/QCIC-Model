function pic_GSA_para_K1()

file_1 = './Data_GSA_para/K1_GSA.mat';
...
text(3.5e9,80,'DCR','FontSize',26,'color','#000000');
text(3.5e9,20,'PD','FontSize',26,'color','#000000');

%% Output image setting

set(gca,'XLim',[a b]);
set(gca,'YLim',[0 100]);
set(gca,'XTickLabel',{'2.5\times10^{9}','3\times10^{9}','3.5\times10^{9}'});
set(gca,'Linewidth',1);
set(gca,'FontSize',18);
set(gca,'FontName','Arial');
xlabel('Carrying capacity of DSTC {\bf (K_1)} ');
ylabel('RECIST (%)');
set(gcf,'unit','centimeters','position',[4 20 18 10])
print('K1_GSA','-dpng','-r600')
